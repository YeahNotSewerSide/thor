...
func (e *energyContract) Native(state *state.State, blockTime uint64, authorityContract *authority.Authority) *energy.Energy {
	return energy.New(e.Address, state, blockTime, authorityContract)
}
